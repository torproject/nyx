...
from seth import __version__, __release_date__
from seth.util import panel, ui_tools
...
def finalize():
  ...
  seth.controller.get_controller().request_redraw()
...
def show_about_popup():
  ...
  try:
    ...
    popup.addstr(1, 2, "seth, version %s (released %s)" % (__version__, __release_date__), curses.A_BOLD)
    popup.addstr(2, 4, "Written by Damian Johnson (atagar@torproject.org)")
    popup.addstr(3, 4, "Project page: www.atagar.com/seth")
