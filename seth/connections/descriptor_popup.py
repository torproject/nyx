...
import seth.popups
import seth.connections.conn_entry
...
def show_descriptor_popup(conn_panel):
  ...
  try:
    while not is_done:
      ...
      display_color = seth.connections.conn_entry.CATEGORY_COLOR[selection.get_type()]
      ...
      popup, _, height = seth.popups.init(popup_height, popup_width)
