...
from seth.util import log, tor_controller
...
def _process_for_ports(local_ports, remote_ports):
  ...
  # atagar@fenrir:~/Desktop/seth$ lsof -i tcp:51849 -i tcp:37277
...
class ResourceTracker(Daemon):
  ...
  def get_value(self):
    ...
    :returns: latest :data:`~seth.util.tracker.Resources` we've polled
    """
