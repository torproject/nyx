...
def set_color_override(color = None):
  ...
  if color is None:
    seth_config.set('features.color_override', 'none')
  elif color in COLOR_LIST.keys():
    seth_config.set('features.color_override', color)
  else:
...
def disable_acs():
  ...
  http://www.atagar.com/seth/images/acs_display_failure.png
  """
